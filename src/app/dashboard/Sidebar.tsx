...
export default function Sidebar({ onNavigate }: { onNavigate: () => void }) {
  ...
  return (
    <aside className="absolute inset-y-0 left-0 z-30 flex w-[min(16rem,85vw)] shrink-0 flex-col border-r border-slate-200 bg-white px-3 py-5 shadow-lg md:relative md:z-auto md:w-64 md:shadow-none">
